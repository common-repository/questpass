...
class SubscriptionsContextProvider implements ContextProvider
{
    ...
    {
        $valueKeys = array(static::IS_SUBSCRIPTION_ACTIVE, static::IS_SUBSCRIPTION_AVAILABLE, static::IS_SUBSCRIPTION_RECURRING, static::IS_SUBSCRIPTION_DAYS_LEFT, static::AUTHORIZATION_ERROR, static::IS_LOGGED_IN, static::AUTHORIZATION_URI, static::LOGOUT_URI, static::USER_LOGIN);
        $defaultValues = \array_combine($valueKeys, \array_fill(0, \count($valueKeys), \false));
