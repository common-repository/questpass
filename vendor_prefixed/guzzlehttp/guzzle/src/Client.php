...
use QuestpassVendor\GuzzleHttp\Cookie\CookieJar;
use QuestpassVendor\GuzzleHttp\Exception\GuzzleException;
use QuestpassVendor\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \QuestpassVendor\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
