 ...
 */
namespace QuestpassVendor\League\OAuth2\Client\Provider;

use QuestpassVendor\GuzzleHttp\Client as HttpClient;
use QuestpassVendor\GuzzleHttp\ClientInterface as HttpClientInterface;
use QuestpassVendor\GuzzleHttp\Exception\BadResponseException;
use QuestpassVendor\League\OAuth2\Client\Grant\AbstractGrant;
use QuestpassVendor\League\OAuth2\Client\Grant\GrantFactory;
use QuestpassVendor\League\OAuth2\Client\OptionProvider\OptionProviderInterface;
use QuestpassVendor\League\OAuth2\Client\OptionProvider\PostAuthOptionProvider;
use QuestpassVendor\League\OAuth2\Client\Provider\Exception\IdentityProviderException;
use QuestpassVendor\League\OAuth2\Client\Token\AccessToken;
use QuestpassVendor\League\OAuth2\Client\Token\AccessTokenInterface;
use QuestpassVendor\League\OAuth2\Client\Tool\ArrayAccessorTrait;
use QuestpassVendor\League\OAuth2\Client\Tool\GuardedPropertyTrait;
use QuestpassVendor\League\OAuth2\Client\Tool\QueryBuilderTrait;
use QuestpassVendor\League\OAuth2\Client\Tool\RequestFactory;
use QuestpassVendor\Psr\Http\Message\RequestInterface;
use QuestpassVendor\Psr\Http\Message\ResponseInterface;
